  ...
  return (
    <div className="innovation-cinematic" aria-label="Innovación de TeCaiGO">
      <div className="innovation-cinematic__frames" aria-hidden="true">
        {actors.map((actor, index) => (
          <motion.figure
            ...
            animate={{ clipPath: started || index === 0 ? "inset(0 0 0 0%)" : "inset(0 0 0 100%)" }}
            transition={{
          ...
          >
            <motion.img
              ...
              animate={{ scale: started ? 1.015 : 1.08 }}
            ...
            <motion.figcaption
              ...
              animate={{ opacity: started || index === 0 ? 1 : 0, x: started || index === 0 ? 0 : -30 }}
      ...
      <motion.div
        ...
        transition={!started || reduceMotion ? { duration: 0 } : { duration: 8.35, times: [0, 0.04, 0.9, 1], ease: "easeInOut" }}
      >
